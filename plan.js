...
export const PLAN = [
  {
    ...
    exercises: [
      { name: "Panca piana bilanciere", setsReps: "3 × 6-8", recText: "2 min", restSeconds: 120, superset: false },
      ...
      { name: "Crunch a terra + Plank", setsReps: "3 × 15-20 / 3 × max", recText: "60 sec", restSeconds: 60, superset: true },
    ],
  },
  {
    day: "B",
    ...
    exercises: [
      ...
      { name: "Leg raise + Russian twist", setsReps: "3 × 12-15 / 3 × 20", recText: "60 sec", restSeconds: 60, superset: true },
    ],
  },
  {
    day: "C",
